...
extern std::string normal_chars, yellow_chars, red_chars, green_chars, blue_chars, yellow_backg_chars, cyan_chars;
...
extern unsigned int isSector1; //generic
extern unsigned int isSector2; //generic
...
extern unsigned int isModifyingScore; //generic
